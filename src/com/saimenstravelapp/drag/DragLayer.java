...
public GridView getOpenCardGridView ()
{
   //if (mGridView == null) {}
   return openCardGridView;
} // end getGridView
...
public void setOpenCardGridViewGridView (GridView newValue)
{
   openCardGridView = newValue;
}
...
public void onDragStart(DragSource source, Object info, int dragAction) 
{
    ...
    if (mGridView != null) {
       int numVisibleChildren = mGridView.getChildCount();
     	Log.d("onDragStart", Integer.toString(numVisibleChildren));
    ...
    if(openCardGridView != null){
    	Log.d("onDragStart", "openCardGridView not null");
      int numVisibleChildren = openCardGridView.getChildCount();
      for ( int i = 0; i < numVisibleChildren; i++ ) {
          DropTarget view = (DropTarget) openCardGridView.getChildAt (i);
          mDragController.addDropTarget (view);
      }
    }
//
