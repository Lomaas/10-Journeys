...
public class Constants {
	...
	public static Integer[] imageArray = {
		...
		R.drawable.cards_finland, R.drawable.cards_russia,
	...
	public static Integer[] profileArray = {
		R.drawable.ic_launcher,
		R.drawable.smileys_angel, R.drawable.smileys_birthday,
		R.drawable.smileys_china, R.drawable.smileys_clown,
		R.drawable.smileys_dectectiv, R.drawable.smileys_devil,
		R.drawable.smileys_funky, R.drawable.smileys_gamer,
		R.drawable.smileys_hipster, R.drawable.smileys_jew,
		R.drawable.smileys_killer, R.drawable.smileys_midtskill,
		R.drawable.smileys_nerd, R.drawable.smileys_niceguy,
		R.drawable.smileys_oneeye, R.drawable.smileys_rocker
	};
}
